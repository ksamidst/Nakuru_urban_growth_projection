...
os.chdir("C:\GEE Code Files\CELLULAR AUTOMATA\URBANIZATION SIMULATION")

# Input land cover GeoTIFF for two time period
file1 = "Actual_2010.tif"
file2 = "Actual_2020.tif"

# Input all the parameters
cbd = "cbddist.tif"
road = "roaddist.tif"
restricted = "dda_2021_government_restricted_2.tif"
pop99 = "den1999.tif"
pop09 = "den2009.tif"
pop19 = "den2019.tif"
pop29 = "den2029.tif"
...
myFactors = growthFactors(cbd, road, pop29, slope, restricted)
...
caModel.exportPredicted('NEW_predictedlandcover_ra_30m_2030N.tif')
